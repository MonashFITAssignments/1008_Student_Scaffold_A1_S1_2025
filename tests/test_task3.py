...
class TestGame(TestCase):
    ...
    def test_crazy_crazy(self) -> None:
    ...
    def test_crazy_draw_four(self) -> None:
        ...
        self.assertEqual(
            self.players[0].cards_at_hand(),
            7,
            f"Alice should have 7 cards, but has {self.players[0].cards_at_hand()}",
        )
        ...
        self.assertEqual(
            self.players[0].cards_at_hand(),
            11,
            f"Alice should have 11 cards, but has {self.players[0].cards_at_hand()}",
        )
    ...
    def test_draw_card_not_playing(self) -> None:
        ...
        self.assertEqual(
            self.players[0].cards_at_hand(),
            8,
            f"Alice should have 8 cards, but has {self.players[0].cards_at_hand()}",
        )
    ...
    def test_draw_card_playing(self) -> None:
        ...
        # Check the number of cards for the next player
        self.assertEqual(
            self.players[1].cards_at_hand(),
            7,
            f"Alice should have 7 cards, but has {self.players[1].cards_at_hand()} cards",
        )

        # Draw a card (seeded to be a valid card so it can be played)
        self.game.draw_card(self.players[1], True)

        # Check the number of cards for the next player
        self.assertEqual(
            self.players[1].cards_at_hand(),
            8,
            f"Alice should have 8 cards after playing the drawn card, but has {self.players[1].cards_at_hand()}",
        )
